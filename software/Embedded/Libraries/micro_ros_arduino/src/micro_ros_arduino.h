...
static inline void set_microros_native_ethernet_udp_transports(byte mac[], IPAddress client_ip, IPAddress agent_ip, uint16_t agent_port, uint8_t w5500_cspin, uint8_t SCLKpin, uint8_t MISOpin, uint8_t MOSIpin){

	static struct micro_ros_agent_locator locator;
   	Ethernet.begin(mac, w5500_cspin, SCLKpin, MISOpin, MOSIpin);
	delay(1000);
