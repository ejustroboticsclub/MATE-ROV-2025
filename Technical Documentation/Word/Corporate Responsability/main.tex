...
\begin{figure}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Workshop1.jpg}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{workshop2.jpg}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Mekatro1.jpg}
    ...
    \begin{minipage}{0.465\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ameer's session .jpg}
