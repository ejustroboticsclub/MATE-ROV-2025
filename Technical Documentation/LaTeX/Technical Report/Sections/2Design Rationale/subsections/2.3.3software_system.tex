...
\hspace{10pt} This year, we have transitioned fully to ROS 2, eliminating the centralized master dependency. Communication between the topside control unit and the ROV unit is now handled using ROS2 \& CAN communication, which is more reliable, scalable, and real-time capable.
