...
class CalibrationNode(Node):
    ...
    def __init__(self):
        ...
        self.rotating_45_button_subscriber = self.create_subscription(
            Bool, "ROV/rotating_45_", self.rotating_45_button_callback, 10
        )
        """
    ...
    def rotating_45_button_callback(self, msg: Bool):
        if msg.data:
            self.desired.pitch=45
        else:
            self.desired.pitch=0
