...
class _GameController(Controller):
    def __init__(self, axis_map, button_id):
        ...
        ###
        self.rotating_45_button=False
        self.rotating_45_button_is_down=True
    ...
    def rotating_45_ROV(self):
        """button for rotating the ROV 360 degree around itself"""
        if self.joystick.get_button(10):  
            if not self.rotating_45_button_is_down:
                self.rotating_45_button=not self.rotating_45_button
            self.rotating_45_button_is_down = True
        else:
            self.rotating_45_button_is_down = False
    # ###
...
class JoyStickNode(Node): 
    def __init__(self):
        ...
        self.rotating_45_ROV_publisher=self.create_publisher(Bool, "ROV/rotating_45_", 1)
        ...
        # Message for rotation mode.
        self.rotatingROV_msg = Bool()
        self.rotatingROV_msg.data = False
        self.prev_rotating = False

        ###
        self.rotating_45_ROV_msg=Bool()
        self.rotating_45_ROV_msg.data=False
    ...
    def update(self):
        ...
        #
        self.controller.rotating_45_ROV()
        ...
        self.rotating_45_ROV_msg.data=self.controller.rotating_45_button
        self.rotating_45_ROV_publisher.publish(self.rotating_45_ROV_msg)
        # print(self.controller.rotating_button)
